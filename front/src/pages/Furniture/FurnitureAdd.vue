        ...
        <q-card>
          <q-card-section>
            <FieldArray name="medias" v-slot="{ fields, push, remove, move }">
              <div class="fit row wrap items-center FurnitureAdd-medias">
                <template
                ...
                >
                  <q-img
                    ...
                    spinner-color="white"
                    class="q-ma-md FurnitureAdd-media"
                  >
                    <q-icon
                      class="absolute all-pointer-events FurnitureAdd-media-icon"
                      size="32px"
